class BandsController < ApplicationController
  ...
  private
    ...
    def band_params
      params.require(:band).permit(:band_name, :genre, :email, :phone_number, :home_town, :facebook, :soundcloud, :reverbnation, :band_camp, :venue_id, :password, :password_confirmation)
    end
end
